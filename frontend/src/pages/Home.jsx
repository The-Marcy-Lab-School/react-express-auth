...
export default function HomePage() {
  return <>
    ...
    <section className='section is-medium has-text-centered' id='landingSection2'>
      ...
      <p className='is-size-4 py-5 pb-5'> Browse events, and easily join to make a positive impact in your own neighborhood!
      <br></br>
       Connect with like-minded people, and even organize your own event.
      <br></br>
