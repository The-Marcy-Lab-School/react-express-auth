import { fetchRecentEvents, fetchCommentsOnEvent } from "../adapters/event-adapter";
...
export default function HomePage() {
  ...
  return <>
    ...
    {events[0] && events.map((event) => {
      return <Event key={event.id - 800} event={event} loadJoinedEvents={loadJoinedEvents} joinedEvents={joinedEvents}/>
    })}
  </>;
}
