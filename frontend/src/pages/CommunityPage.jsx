    ...
    <>
      <div class="navigation">
        ...
        <div class="fixed -translate-y-3">
          <img
            class="absolute rounded-sm ml-24 mt-5"
            src={logo}
            alt="Smiley face"
            width="72"
            height="72"
      ...
      <div class="flex items-center justify-center">
        <div class="relative w-96 h-16 mt-9 border border-gray-200 shadow-md bg-white rounded-full">
          <input
            class="absolute inset-0 m-3 ml-5 outline-none text-base"
            type="text"
            placeholder="Type something..."
          />
          <button
            class="absolute inset-y-0 right-0 w-14 h-5/6 mt-1 rounded-full bg-transparent border-none outline-none"
            type="submit"
