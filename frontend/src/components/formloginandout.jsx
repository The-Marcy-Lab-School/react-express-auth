      ...
      <div>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            ...
            <a href="#" onClick={() => setActiveTab('events')} className="font-semibold leading-6 text-red-500 hover:text-red-200">
              Join Us!
            </a>
          </p>
        </div>
      ...
      <div>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form   
            ...
            aria-labelledby="create-heading" className="space-y-6">
          <div>
              <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900">
                Username
              </label>
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Already In?{' '}
            <a href="#" onClick={() => setActiveTab('management')} className="font-semibold leading-6 text-red-500 hover:text-red-200">
              Log Back In!
            </a>
          </p>
        </div>
