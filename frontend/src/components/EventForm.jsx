  ...
  return (
    <div>
        ...
        <div className="mt-10 px-5 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={submit} aria-labelledby="login-heading" className="space-y-6">
          <div>
            ...
            {/* py-1.5 pl-3 pr-10 */}
            <div>
              <label htmlFor="location" className='block text-sm font-medium leading-6 text-gray-900'>Select a park</label>
              <select className='relative w-full cursor-default rounded-md bg-white p-2 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-red-600 sm:text-sm sm:leading-6' id="location" name="location" required defaultValue={''}>
            ...
            <label className='block text-sm font-medium leading-6 text-gray-900' htmlFor="date">Visit Date</label>
            <input className='relative w-full cursor-default rounded-md bg-white p-2 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-red-600 sm:text-sm sm:leading-6' type="date" id="date" name="date" required min={min} style={{marginTop: '0px'}} />

            
            <label className='block text-sm font-medium leading-6 text-gray-900' htmlFor="startTime">Select a start time</label>
            <input
              type="time"
              id="startTime"
              name="startTime"
            ...
            <label className='block text-sm font-medium leading-6 text-gray-900' htmlFor="endTime">Select an end time</label>
            <input
              type="time"
              id="endTime"
              name="endTime"
            ...
            <legend className='block text-sm font-medium leading-6 text-gray-900'>Select Tags</legend>
            <div className='flex flex-col'>
              {tags.map((tag, idx) => (
                <label key={tag} className='flex flex-row text-center font-semibold'>
                  <input
                    type="checkbox"
                    id={tag}
                  name="tags"
          ...
          <div>
              ...
              <p className="mt-10 text-center text-sm text-gray-500"> Enjoy your Event </p>
            </div>
