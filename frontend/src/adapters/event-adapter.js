...
export const createEvent = async ({ title, location, description, img, date, end_date, user_id}) => (
    fetchHandler(baseUrl, getPostOptions({ title, location, description, img, date, end_date, user_id }))
  );
  export const joinAnEvent = async ({  user_id, event_id}) => {
    console.log(user_id, event_id)
    fetchHandler(`${baseUrl}/relations/${event_id}`, getPostOptions({ user_id, event_id}))
  };
  export const leaveAnEvent = async ({  user_id, event_id}) => {
    console.log(user_id, event_id)
    fetchHandler(`${baseUrl}/relations/${event_id}`, deleteOptions({ user_id, event_id}))
