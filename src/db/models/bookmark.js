...
class Bookmarks {
  ...
  static async find(id) {
    const query = `SELECT bookmark.id, facility_doctor, specialty, address, photo, bookmark.user_id FROM bookmark JOIN pages ON bookmark.page_id = pages.id WHERE bookmark.user_id =?`;
